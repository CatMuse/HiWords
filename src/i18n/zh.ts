...
export default {
    ...
    notices: {
        ...
        ai_api_key_reset: "API Key 存储方式已升级，请在 HiWords 设置中重新选择或添加密钥。",
    ...
    library: {
        ...
        section_memory: "记忆提示",
        section_derived_words: "派生词",
        section_images: "图片",
        section_custom: "自定义内容",
        section_note: "备注",
    ...
    popover: {
        ...
        deleting_note: "正在删除…",
        current_note: "当前笔记",
        no_examples: "当前内容中没有找到可用例句。",
        searching_context: "正在检索知识库…",
        no_context: "未在 Markdown 笔记中找到这个单词。",
        context_found: "来自 {1} 篇笔记的 {0} 条语境",
        context_count: "{0} 条语境",
        context_count_one: "1 条语境",
        load_more_context: "查看更多",
        loading_more_context: "正在加载…",
        search_whole_vault: "搜索整个仓库",
        no_quick_context: "未在关联笔记或最近笔记中找到相关语境。",
        back: "返回词卡",
    },
    // 划词翻译
    translate: {
