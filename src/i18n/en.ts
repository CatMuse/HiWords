...
export default {
    ...
    notices: {
        ...
        ai_api_key_reset: "API key storage has been upgraded. Select or add your API key again in HiWords settings.",
    ...
    library: {
        ...
        section_derived_words: "Derived words",
        section_images: "Images",
        section_custom: "Custom content",
        section_note: "Note",
    ...
    popover: {
        ...
        examples: "Sentence",
        context: "Context",
        examples_title: "Sentence",
        context_title: "Vault context",
        note_title: "My note",
        saving_note: "Saving…",
        deleting_note: "Deleting…",
        current_note: "Current note",
        no_examples: "No example was found for this occurrence.",
        searching_context: "Searching your vault…",
        no_context: "This word was not found in your Markdown notes.",
        context_found: "{0} contexts from {1} notes",
        context_count: "{0} contexts",
        context_count_one: "1 context",
        load_more_context: "Load more",
        loading_more_context: "Loading…",
        search_whole_vault: "Search entire vault",
        no_quick_context: "No contexts were found in related or recent notes.",
        back: "Back to card",
    },
    // Selection translate
    translate: {
